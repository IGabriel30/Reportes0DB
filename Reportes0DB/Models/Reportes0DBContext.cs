...
{
    public partial class Reportes0DBContext : DbContext
    {
        public Reportes0DBContext()
        {
        }

        public Reportes0DBContext(DbContextOptions<Reportes0DBContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Reportes0DB;Integrated Security=True;Trust Server Certificate=True");
//            }
        }
